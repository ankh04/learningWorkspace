# 数据面板
您一共完成了 866 个task，完成的项目数量为 601，完成率为 69.39999999999999%。
共观看了 24 部剧集，分别是
- 名称：水浒传, 天数：8
- 名称：叶问, 天数：1
- 名称：爱的曝光, 天数：1
...
- 名称："昆池岩", 天数：1
- 名称："从海底出击", 天数：1
- 名称："勇敢的心：维拉斯克兹的故事", 天数：1
- 名称："被嫌弃的松子的一生", 天数：1
- 名称："The boys", 天数：1
- 名称："[青春变形记](https://www.lgyy.cc/vodplay/49745-1-1.html)", 天数：1
...
- 名称："计算机网络-网络层", 天数：1
- 名称："操作系统", 天数：2
- 名称："编译原理-自底向上的语法分析-符号语法", 天数：1
- 名称："risc-v", 天数：1
- 名称：Rust, 天数：2
- 名称："操作系统-批处理系统", 天数：1
- 名称："编译原理-自底向上的语法分析", 天数：2
- 名称："操作系统-优先级机制", 天数：1
- 名称："计算机组成原理-算数运算原理", 天数：1
- 名称："计算机网络-网络层控制平面", 天数：1
- 名称："算法-图论算法", 天数：2
- 名称："Rust" [[rust视频笔记row]], 天数：3
- 名称："计算机网络-UDP&TCP", 天数：1
- 名称："尼采", 天数：1
- 名称："编译原理-翻译模式", 天数：1
- 名称："NLP-概述", 天数：1
- 名称："深度学习-CBOW", 天数：1
- 名称："Hash", 天数：1
- 名称："voice feminization", 天数：1
- 名称："算法-红黑树"Rust, 天数：1
- 名称："性别理论-脉络梳理", 天数：1
- 名称："虚拟内存", 天数：1
- 名称："词根", 天数：1
- 名称："浏览器HTML与CSS引擎原理", 天数：1
- 名称："HTML", 天数：1
- 名称："语言哲学", 天数：1
- 名称："有机化学-成键", 天数：1
- 名称："药理学" [地址](https://www.bilibili.com/video/BV1dv411V7cw?p=2&vd_source=96c18635d20f0cc3b2c33ac78719180e), 天数：1
- 名称："CSAPP", 天数：1
- 名称："Spring", 天数：1
